...
from pipeline.extractors.customer_orders.sources.customer_orders_db_repository import load_customers, load_orders, \
...
from pipeline.extractors.customer_orders.sources.stores_csv_repository import load_stores_from_csv
